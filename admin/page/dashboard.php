...
<script type="text/javascript">
    window.onload = function() {
        ...
        var chart = new CanvasJS.Chart("chart3", {
            ...
            subtitles: [{
                text: "Jumlah Keseluruhan Users Sistem Sesuai Bidang & Gender"
            }],
            axisX: {
            ...
            data: [{
                    ...
                    dataPoints: [{
                        ...
                        },
                        {
                            ...
                            y: <?php
                                $jumlah_kepsek_laki_laki = mysqli_query($conn, "SELECT * FROM pengguna WHERE (role='2' and kelamin='L') ");
                                echo mysqli_num_rows($jumlah_kepsek_laki_laki);
                                ?>
                        },
                        {
                            label: "Guru",
                ...
                },
                {
                    ...
                    dataPoints: [{
                        ...
                        },
                        {
                            label: "Kepala Sekolah",
                            y: <?php
                                $jumlah_kepsek_perempuan = mysqli_query($conn, "SELECT * FROM pengguna WHERE (role='2' and kelamin='P') ");
                                echo mysqli_num_rows($jumlah_kepsek_perempuan);
                                ?>
                        },
                        {
                            label: "Guru",
