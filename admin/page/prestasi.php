<div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12">
                <button data-toggle="collapse" class="btn btn-dark btn-block" data-target="#addPrestasi">Tambah Prestasi</button>
                <div id="addPrestasi" class="collapse mt-2 mb-2">
                    <div class="card">
                        <div class="mt-2 mb-2 ml-2 mr-2">

                            <form action="?adm=add-prestasi" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Konten Prestasi</label>
                                    <textarea id="editor" name="isi" class="form-control"></textarea>
                                </div>

                                <div class="form-group">
                                    <label>Gambar Prestasi <sup>Ukuran max dibawah 2mb </sup></label>
            ...
            $no = 1;
            $data = mysqli_query($conn, "SELECT * FROM data_prestasi ORDER BY `id` DESC");
            while ($d = mysqli_fetch_array($data)) {
            ?>
                <div class="col-sm-6 mb-3" style="width: 100% ;">
                    <div class="row">
                        <div class="col-sm-6">
                            <a href="?adm=delete-prestasi&id=<?php echo $d['id']; ?>" class="btn btn-sm btn-danger btn-block">Hapus Prestasi</a>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="card">
                        <img src="logic/prestasi_sklh/<?php echo $d['foto']; ?>" class="card-img-top w3-grayscale-min" alt="<?php echo $d['foto']; ?>" style="object-fit: cover; height: 200px">
