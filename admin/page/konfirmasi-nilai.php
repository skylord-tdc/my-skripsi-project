<div>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb" style="font-size: 11px;">
            ...
            <li class="breadcrumb-item"><a href="?adm=da3"><?php echo $nm_mapel; ?></a></li>
            <li class="breadcrumb-item active" aria-current="page">Konfirmasi Simpan Nilai</li>
        </ol>
    </nav>
    ...
    <div class="card">
        <div class="mt-3 mb-3">
            ...
            <div>
                ...
                <form action="?adm=input-nilai" method="post">
