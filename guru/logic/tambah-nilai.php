...
if (isset($_POST['Submit'])) {
    ...
    $cek = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM data_nilai WHERE (id_kls='$id_kls' and nis='$nis' and kls='$kls' and smstr='$smstr_cari' and thn_pelajaran='$thn_pelajaran' and nm_mapel='$nm_mapel') "));
    if ($cek > 0) {
        ...
        "   <script type='text/javascript'>
            window.location='./guru?gru=buka-kelas&thn_angkatan=$thn_angkatan&kompetensi=$kompetensi&nm_mapel=$nm_mapel&kls=$kls&smstr_cari=$smstr_cari&thn_pelajaran_cari=$thn_pelajaran';
    </script>";
    } else {
        // Insert data 
