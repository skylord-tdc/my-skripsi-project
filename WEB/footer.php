      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-3 footer-links">
          ...
          <ul>
            ...
            <li><i class="bx bx-chevron-right"></i> <a href="#pengumuman">Pengumuman Sekolah</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="#kegiatan">Kegiatan Sekolah</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="#capaian">Prestasi Sekolah</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="semua-berita">Berita</a></li>
          </ul>
        </div>
