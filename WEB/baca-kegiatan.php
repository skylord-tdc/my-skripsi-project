                    ...
                    <div class="row g-5">
                        <div class="col-md-8">
                            ...
                            <article class="blog-post">
                                ...
                                $no = 1;
                                $data = mysqli_query($conn, "SELECT * FROM data_kegiatan WHERE slug='$berkas' ");
                                ...
                                ?>
                                    ...
                                    <img src="../admin/logic/kegiatan_sklh/<?php echo $d['foto']; ?>" alt="<?php echo $d['foto']; ?>" style="object-fit: cover; width: 100%; height: 315px ;">
                                    <p><?php echo $d['isi']; ?></p>
                        ...
                        <div class="col-md-4">
                            <div class="position-sticky" style="top: 2rem;">
                                <div class="p-4 mb-3 bg-light rounded">
                                    ...
                                    <p class="mb-0">Pantau terus kegiatan terbaru yang akan disajikan untuk mu hanya pada website ini.</p>
                                </div>

                                <div class="p-4">
                                    <h4 class="fst-italic">Kegiatan Terbaru</h4>
                                    <ol class="list-unstyled mb-0">
                                        <?php
                                        include '../login/conn.php';
                                        // untuk pengulangan penomeran
                                        $no = 1;
                                        $data = mysqli_query($conn, "SELECT * FROM data_kegiatan ORDER BY `id` DESC LIMIT 12 ");
                                        while ($d = mysqli_fetch_array($data)) {
                                        ?>
